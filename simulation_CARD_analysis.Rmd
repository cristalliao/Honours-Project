---
title: "simulation_CARD_analysis"
...
### Pattern label
pattern_gp_label = readRDS("/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/pattern_gp_label_human_heart.rds")

### Load functions
generateMultiN = readRDS("/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/generateMultiN_human_heart.rds")

generateSpatial_norep_fixedProp = readRDS("/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/generateSpatial_norep_fixedProp_human_heart.rds")

ct.varname = "cellType"
ct.select = c("Erythrocytes",
...
imix <- 0
ntotal <- 10
mix1 = mix2 = mix3 = mix4 = mix5 = c(1 - (0.2 * imix),0.2*imix)
...
```{r}
saveRDS(simulated_results,"/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/simulated_results_n30.rds")
```

```{r}
# Check one of the results (for example, the first result)
simulated_results[[20]]
```
...
for (i in 1:length(simulated_results)) {
  ...
  hmrf_folder_human_heart = paste0(getwd(),'/','hmrf_folder_save/')
  if(!file.exists(hmrf_folder_human_heart)) dir.create(hmrf_folder_human_heart, recursive = T)
  ...
  HMRF_spatial_genes = doHMRF(gobject = my_giotto_object,
                              ...
                              k = 5,
                              betas = c(28,2,2),
                              output_folder = paste0(hmrf_folder_human_heart, '/',
...
```{r}
write.csv(ARI_df,"/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/ARI_df.csv")
write.csv(NMI_df,"/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/NMI_df.csv")
write.csv(intensity_k_means_PCA_df,"/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/intensity_k_means_PCA_df.csv")
write.csv(intensity_hclust_PCA_df,"/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/intensity_hclust_PCA_df.csv")
write.csv(intensity_louvain_PCA_df, "/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/intensity_louvain_PCA_df.csv")
write.csv(spatial_cluster_Giotto_df, "/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/spatial_cluster_Giotto_df.csv")
write.csv(spatial_cluster_BayesSpace_df, "/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/spatial_cluster_BayesSpace_df.csv")
write.csv(spatial_cluster_Banksy_df, "/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/spatial_cluster_Banksy_df.csv")
write.csv(k_means_RCTD_df, "/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/k_means_RCTD_df.csv")
write.csv(k_means_CARD_df, "/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/k_means_CARD_df.csv")
```


```{r}
ARI_df = read.csv("/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/ARI_df.csv")
NMI_df = read.csv("/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/NMI_df.csv")
intensity_k_means_PCA_df = read.csv("/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/intensity_k_means_PCA_df.csv")
intensity_hclust_PCA_df = read.csv("/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/intensity_hclust_PCA_df.csv")
intensity_louvain_PCA_df = read.csv("/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/intensity_louvain_PCA_df.csv")
spatial_cluster_Giotto_df = read.csv( "/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/spatial_cluster_Giotto_df.csv")
spatial_cluster_BayesSpace_df = read.csv( "/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/spatial_cluster_BayesSpace_df.csv")
spatial_cluster_Banksy_df = read.csv("/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/spatial_cluster_Banksy_df.csv")
k_means_RCTD_df = read.csv("/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/k_means_RCTD_df.csv")
k_means_CARD_df = read.csv("/dski/nobackup/xiaoyinl/human_heart_analysis/simulation_slice6_results/CARD_simulation_results_new/k_means_CARD_df.csv")
```
